...
export default function AnalysisRoles() {
  ...
  return (
    <div className="px-4 sm:px-6 lg:px-8">
                ...
                <thead>
                  <tr>                  
                    ...
                    <th
                      scope="col"
                      className="px-3 py-3 text-left text-xs font-medium uppercase tracking-wide text-gray-500 cursor-pointer"
                      onClick={() => handleSort('inlinePoliciesCount')}
                    >
                    ...
                    <th
                      scope="col"
                      className="px-3 py-3 text-left text-xs font-medium uppercase tracking-wide text-gray-500 cursor-pointer"
                      onClick={() => handleSort('attachedPoliciesCount')}
                    >
      ...
      {selectedRole && <Overlay open={showOverlay} setOpen={setShowOverlay} entity={selectedRole} />}
